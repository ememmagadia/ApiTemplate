...
namespace Api.Controllers
{
    ...
    public class TokenController : BaseApiController
    {
        ...
        #region Constructor
        public TokenController(ApiDbContext context, RoleManager<ApplicationRole> roleManager, UserManager<ApplicationUser> userManager, IConfiguration configuration)
